      ...
      <Card className="w-full max-w-md rounded-[2rem] medical-shadow border-primary/10 overflow-hidden">
        ...
        <CardContent className="p-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-accent px-2">Password</label>
              <Input 
                type="password" 
                required
                placeholder="••••••••"
            ...
            <Button 
              disabled={loading}
              className="w-full bg-primary hover:bg-primary/90 rounded-full py-8 text-xl font-bold shadow-xl shadow-primary/20 mt-4"
            >
